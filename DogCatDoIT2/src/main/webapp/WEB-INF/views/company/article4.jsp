            ...
            <div class="row learts-mb-n40">
                ...
                <div class="col-lg-6 col-12 learts-mb-40">
                    <div class="product-summery">
                        ...
                        <h3 class="product-title">두잇 스테이</h3>
                        <div class="product-description">
                            100% 예약제로 운영되는 오픈형 반려동물 호텔 두잇 스테이입니다. 소중한 가족과 교감하며 고객님의 충분한 휴식과 즐거운 여가 시간을 보장합니다. 
                        </div>
            ...
            <div class="tab-content product-infor-tab-content">
                        ...
                        <div class="col-12 learts-mb-30">
                            <div class="row learts-mb-n10">
                                <div class="col learts-mb-10" style="text-align: center;">
                                    <p>100% 예약제로 운영되는 오픈형 반려동물 호텔 두잇 스테이입니다.<br>소중한 가족과 교감하며 고객님의 충분한 휴식과 즐거운 여가 시간을 보장합니다. </p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="tab-pane fade" id="tab-reviews">
                    ...
                    <div class="product-review-wrapper">
                        <span class="title">1개의 두잇 스테이 이용 후기</span>
            ...
            <div class="row learts-mb-n30">
                ...
                <div class="col-lg-4 col-md-6 col-12 learts-mb-30">
                    <div class="contact-info">
                        ...
                        <span class="info"><i class="icon fal fa-envelope"></i> 이메일: <a href="#">contact@doitstay.com</a></span>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-12 learts-mb-30">
                    <div class="contact-info">
