...
<c:forEach var="vo" items="${listAllCategory}">
	<tr>
		...
		<td>
			...
			<span class="btnSpanIcon btnUpdateIcon" title="수정"><i class="icofont-edit"></i></span>
			<span class="btnSpanIcon btnDeleteIcon" title="삭제"><i class="icofont-trash"></i></span>
			<span class="btnSpanIcon btnUpdateOkIcon" title="수정완료" style="display: none;"><i class="icofont-ui-check"></i></span>
			<span class="btnSpanIcon btnUpdateCancelIcon" title="수정취소" style="display: none;"><i class="icofont-undo"></i></span>
		</td>
	</tr>
</c:forEach>
