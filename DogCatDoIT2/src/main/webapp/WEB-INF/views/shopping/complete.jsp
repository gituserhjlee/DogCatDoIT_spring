...
<div class="container">
		...
		<table class="table1">
			...
			<tr>
				...
				<td class="col3">
					<fmt:formatNumber type="number" value="${dto.totalPayment}" maxFractionDigits="3"/> 원
				</td>
			</tr>
			<tr>
				<td class="col2">상품가격</td>
				<td class="col3">
					<fmt:formatNumber type="number" value="${dto.totalItemPrice}" maxFractionDigits="3"/> 원
				</td>
			</tr>
			<tr>
				<td class="col2">배송비</td>
				<td class="col3">
					<fmt:formatNumber type="number" value="${dto.deliveryPrice}" maxFractionDigits="3"/> 원
				</td>
			</tr>
			<tr>
				<td class="col2">할인금액</td>
				<td class="col3">
					<fmt:formatNumber type="number" value="${dto.totalDiscount}" maxFractionDigits="3"/> 원
				</td>
			</tr>
			<tr>
				<td colspan="2"><hr></td>
		 	...
		 	<tr>
		 		...
		 		<td class="col3">
		 			<fmt:formatNumber type="number" value="${dto.totalItemPrice + dto.deliveryPrice}" maxFractionDigits="3"/> 원
		 		</td>
			</tr>
			<tr class="tr-bot">
				<td colspan="3"></td>
		...
		<table>
			<tr align="center">
				<td>
					<button type="button" class="btnConfirm" onclick="location.href='${pageContext.request.contextPath}/shopping/mainPage'">확인</button>
				</td>
			<tr>
		</table>
